...
const SKILLS = [
  "JavaScript", "TypeScript", "React", "Next.js 14", "React Native",
  "Node.js", "Express.js", "HTML/CSS", "Tailwind CSS", "MongoDB", "MySQL",
  "REST APIs", "Git/GitHub", "WordPress", "Responsive Design", "SEO",
];
...
const TIMELINE = [
  ...
  { year: "2024", title: "SmartPOS", where: "Personal project · React / Node / MySQL", body: "Built a point-of-sale system with real-time billing, inventory, and product modules." },
  { year: "2024", title: "Stock Price Prediction", where: "Personal · Python ML", body: "Supervised ML model forecasting stock trends with live data feeds and a simple analytics dashboard." },
];
      ...
      <div className="grid lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-5 lg:sticky lg:top-24">
          <div className="relative w-full max-w-sm mx-auto">
            ...
            <div className="relative brutal-lg rounded-3xl overflow-hidden -rotate-2">
              <img src={hamzaImgPath} alt="Hamza Mehmood" className="w-full object-cover" />
            </div>
        ...
        <div className="lg:col-span-7">
          ...
          <h1 className="mt-2 font-display text-6xl sm:text-7xl">
            I build the<br /><span className="text-electric">web</span>, end to <span className="text-pink">end</span>.
          </h1>
          ...
          <div className="mt-14">
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              {SKILLS.map((s) => (
                <span key={s} className="font-mono text-xs px-3 py-1.5 bg-card brutal-sm rounded-md">
                  {s}
                </span>
              ))}
            </div>
            ...
            <ol className="mt-6 space-y-5">
              {TIMELINE.map((t, i) => (
                <li key={i} className="relative pl-6 border-l-2 border-ink">
                  ...
                  <p className="font-mono text-xs text-muted-foreground">{t.year} · {t.where}</p>
